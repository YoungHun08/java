...
class Book {
    ...
    public final void returnBook() {
        if (!isAvailable) {
            ...
            System.out.println("이미 반납된 상태입니다."); // 반납 불감
        }
    }

    // 책 정보 출력 메서드
    void displayInfo() {
        System.out.println("제목 : " + title + " | 저자 : " + author + " | 대여가능여부 : " + (isAvailable ? "대여 가능" : "대여 중"));
    }
}
...
public class D_OOP_Practice {
    public static void main(String[] args) {
        ...
        book1.displayInfo(); // 제목 : 작별하지 않는다., 저자 : 한강, 대여가능여부 : 대여 가능
        ...
        ebook1.displayInfo(); // 제목 : 달러구트 꿈 백화점, 저자 : 이미예, 대여가능여부 : 대여 가능 , 파일 크기 : 867.0MB
