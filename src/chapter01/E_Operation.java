...
public class E_Operation {
    public static void main(String[] args) {
        ...
        // : 삼항 연산자
        // 조건식 ? 조건식이 참인경우 반환 : 조건식이 거짓인 경우 반환;
        ...
        // x와 y를 사용하여
        // x값이 짝수이면 "2의 배수입니다."
        // y값이 홀수이면 "2의 배수가 아닙니다."를 출력

        int x = 10, y = 2; // 같은 자료형일 경우 쉼표로 구분하여 선언 가능
        // int y = 2;

        System.out.println(x % y == 0 ? "2의 배수입니다" : "2의 배수가아닙니다.");
        System.out.println(x / y == 0 ? "2의 배수입니다" : "2의 배수가아닙니다.");
