...
//            System.out.println("외부 클래스 필드에 접근 : " + outerField);
    ...
    // 3. 메서드 내부 클래스 (지역 클래스)
    void outerMethod() {
        String localVar = "메서드 로컬 변수(Final)"; // 암묵적으로 final 간주 (생략)
        final String localFinalVar = "메서드 로컬 변수";
...
public class A_Inner {
    public static void main(String[] args) {
        ...
        // 외부 클래스타입.내부클래스타입 변수 = new 외부클래스명.내부클래스();
        ...
        // 로컬 변수에 접근(Final X)메서드 로컬 변수(Final)
        // 로컬 변수에 접근(Final O)메서드 로컬 변수

        System.out.println(" ");
        System.out.println("=== 익명 (내부) 클래스 ===");
        // 클래스타입 변수명 = enw 클래스명() { 메서드 구현 - 추상클래스, 인터페이스의 추상 메서드 }
